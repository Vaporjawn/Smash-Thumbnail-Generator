...
class Player {
    ...
    set filename(filename) {
        if (filename)
            this.charArray[0].filename = filename;
        else
            this.charArray[0].filename = null;
    }
    get image() {
    ...
    set colorBg(pColor) {
        this.bg.color = pColor;
    }
    get color2Bg() {
        return this.bg.color2;
    }
    set color2Bg(pColor2) {
        this.bg.color2 = pColor2;
    }
