...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      selectedColor: "",
      selectedColorName: "",
      // array-form props keep their kebab-case literal in Vue's TS types even
      // though Vue exposes them camelCased on `this` at runtime - cast to avoid
      // widening the whole props type just for this lookup.
      colors: (this as any).colorOptions,
      noSelection: true,
    };
  },
  computed: {
