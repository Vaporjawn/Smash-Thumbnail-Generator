  ...
  <v-row no-gutters>
    <v-col>
      <v-row no-gutters>
        ...
        <v-col cols="3">
          <v-btn class="ml-2" dark x-small fab color="cyan" @click="reset">
...
export default Vue.extend({
  ...
  methods: {
    reset() {
      let text = this.player.myTag ? this.player.myTag : this.player;
      text.reset();
      
      this.player.align('center', 'middle');
      // TODO a modifier
      if (this.title === "Versus") {
        text.text.center();
      }
    }
  }
